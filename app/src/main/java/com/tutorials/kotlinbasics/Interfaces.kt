...
class ElectricCar1(override val maxSpeed: Double,
                      override val brandName: String,
                      batteryLife: Double) : Car1(maxSpeed, brandName) {
...
fun main(args: Array<String>){
    var audiA3 = Car1(200.0, "Audi")
    var teslaS = ElectricCar1(250.0, "Tesla", 85.0)
